...
echo -i '$a src-git DDNS-GO https://github.com/sirpdboy/luci-app-ddns-go' feeds.conf.default
...
echo -i '$a src-git argon https://github.com/jerrykuku/luci-theme-argon' feeds.conf.default
